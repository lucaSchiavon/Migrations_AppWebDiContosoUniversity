...
using AppWebDiContosoUniversity.Models.SchoolViewModels;
//using ContosoUniversity.Models.SchoolViewModels;

namespace AppWebDiContosoUniversity.Controllers
{
    public class InstructorsController : Controller
    {
       ...
       //viene caricato tutto in un colpo solo anche le tabelle di dettaglio in fondo alla pagina
        ...
        public async Task<IActionResult> EditPost(int? id, string[] selectedCourses)
        {
            ...
            {
                //Se la posizione dell'ufficio è vuota, impostare la proprietà Instructor.OfficeAssignment su Null, 
                //in modo che la riga correlata nella tabella OfficeAssignment venga eliminata.
